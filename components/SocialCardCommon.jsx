...
const SocialCardCommon = ({ type, data }) => {
  ...
  return (
    <div className="bg-white group drop-shadow-primary rounded-secondary px-7 pt-8 pb-4 w-max relative">
        ...
        <div className="mt-2">
          ...
          <div className="text-xs mt-2 mb-8">
            {showDescriptionInput ? (
              ...
              <p className="inline line-clamp-5 break-words">{description}</p>
            )}

            <span
              onClick={handleDescriptionEdit}
              className="cursor-pointer opacity-0 group-hover:opacity-100 ml-2"
            >
              {showDescriptionInput ? (
...
export default SocialCardCommon;
